...
multiple_data1 = pd.read_excel(
    "/Users/tinafung8686/Desktop/python vscode/pandas/Incomplete/Data - Multiple Worksheets.xlsx", sheet_name="Data 1")  # sheet_name = 0
multiple_data2 = pd.read_excel(
    "/Users/tinafung8686/Desktop/python vscode/pandas/Incomplete/Data - Multiple Worksheets.xlsx", sheet_name="Data 2")  # sheet_name = 1
# 同時匯入多張分頁
multiple_data12 = pd.read_excel("/Users/tinafung8686/Desktop/python vscode/pandas/Incomplete/Data - Multiple Worksheets.xlsx",
                                sheet_name=["Data 1", "Data 2"])  # sheet_name = 0,1

# 如果要抓到所有分頁，還可以透過None
# sheet_name = 全部。在 pd.read_excel() 這個函式中，當你將 sheet_name 設為 None 時，Pandas 就會把這個行為解釋為：「使用者沒有指定任何特定的工作表，所以我的預設行為是處理所有工作表。」
multiple_data12 = pd.read_excel(
    "/Users/tinafung8686/Desktop/python vscode/pandas/Incomplete/Data - Multiple Worksheets.xlsx", sheet_name=None)
...
ibm = pd.read_csv("/Users/tinafung8686/Desktop/python vscode/pandas/Incomplete/ibm.csv",
...
plot_data = ibm["Close"].apply(
    average_stock).value_counts().plot(kind="pie", legend=True)
